...
def runner():
    ...
    print(f'train value is {train}')
    print(f'town value is {town}')
    print(f'checkpoint_load value is {checkpoint_load}')
    print(f'total_timesteps value is {total_timesteps}')
    print(f'action_std_init value is {action_std_init}')
